...
w = np.array([10.5]); max_its = 10;
weight_history,cost_history = newtons_method(g,max_its,w)
print(cost_history)
print(weight_history) # steps

animation_visualizer().newtons_method(g,weight_history,savepath="/myPath/nm.mp4",fps=1)
show_video("/myPath/nm.mp4", width=800)